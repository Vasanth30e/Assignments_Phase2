...
namespace TaskCRUD.Controllers
{
    ...
    {
        private readonly TaskCRUDDbContext _context;

        public TasksController(TaskCRUDDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Task != null ? 
                          ...
                          Problem("Entity set 'TaskCRUDDbContext.Task'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TaskCRUDDbContext.Task'  is null.");
            }
            var task = await _context.Task.FindAsync(id);
            if (task != null)
            {
